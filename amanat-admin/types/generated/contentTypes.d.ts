...
export interface ApiCommercialListingCommercialListing
  extends Struct.CollectionTypeSchema {
  collectionName: 'commercial_listings';
  info: {
    description: 'Commercial property listings';
    displayName: 'Commercial Listing';
    pluralName: 'commercial-listings';
    singularName: 'commercial-listing';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    gps_latitude: Schema.Attribute.Decimal;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::commercial-listing.commercial-listing'
    > &
      Schema.Attribute.Private;
...
export interface ApiLandListingLandListing extends Struct.CollectionTypeSchema {
  collectionName: 'land_listings';
  info: {
    description: 'Land property listings';
    displayName: 'Land Listing';
    pluralName: 'land-listings';
    singularName: 'land-listing';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiResidentialListingResidentialListing
  extends Struct.CollectionTypeSchema {
  collectionName: 'residential_listings';
  info: {
    description: 'Residential property listings';
    displayName: 'Residential Listing';
    pluralName: 'residential-listings';
    singularName: 'residential-listing';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::residential-listing.residential-listing'
    > &
      Schema.Attribute.Private;
    price: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::commercial-listing.commercial-listing': ApiCommercialListingCommercialListing;
      'api::land-listing.land-listing': ApiLandListingLandListing;
      'api::residential-listing.residential-listing': ApiResidentialListingResidentialListing;
