...
import { createWhatsAppInquiryUrl } from '../constants/config';
        ...
        <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="grid grid-cols-4 gap-4">
              {property.images.map((img, idx) => (
                <button
                  ...
                  className={`aspect-video overflow-hidden border-2 transition-all ${activeImage === idx ? 'border-brand-gold' : 'border-transparent opacity-50 hover:opacity-100'
                    }`}
                >
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 bg-white dark:bg-brand-navy p-8 border border-slate-200 dark:border-brand-gold/30 shadow-2xl">
              ...
              <a
                href={createWhatsAppInquiryUrl(property.id, lang === Language.ENGLISH ? 'en' : 'fa')}
                target="_blank"
                rel="noopener noreferrer"
