...
export const translations: Record<Language, TranslationSchema> = {
  [Language.DARI]: {
    ...
    home: {
      ...
      trustSubtitle: 'در بازاری که با پیچیدگی‌های بی‌شمار همراه است، ما با اعتبارسنجی نهادی و قاطعانه، هرگونه ریسک را برای شما به صفر می‌رسانیم.',
      featuredTitle: 'ملک ویژه و تایید شده',
      saleSectionTitle: 'خانه‌های فروشی',
      rentSectionTitle: 'خانه‌های کرایی',
      gerawiSectionTitle: 'خانه‌های گروی',
    ...
    status: {
      ...
      placeholder: 'نمونه',
      negotiable: 'جورآمد دارد',
      nonNegotiable: 'بدون جورآمد',
      sold: 'فروخته شده',
      saleType: 'فروش',
      rentType: 'کرایه',
      gerawiType: 'گروی',
      available: 'موجود',
      inNegotiation: 'در حال مذاکره',
      rented: 'به کرایه داده شد'
    },
    details: {
      price: 'قیمت',
      area: 'مساحت',
  ...
  [Language.PASHTO]: {
    ...
    home: {
      ...
      trustSubtitle: 'په هغه بازار کې چې له بې شمیره پیچلتیاوو سره مل وي، موږ د قاطع او بنسټیز تایید سره ستاسو لپاره هر ډول خطر له منځه وړو.',
      featuredTitle: 'ځانګړی او تایید شوی ملکیت',
      saleSectionTitle: 'د پلور لپاره کورونه',
      rentSectionTitle: 'د کرایې لپاره کورونه',
      gerawiSectionTitle: 'د ګروي لپاره کورونه',
    ...
    status: {
      ...
      placeholder: 'نمونه',
      negotiable: 'جوړجاړی لري',
      nonNegotiable: 'پرته له جوړجاړي',
      sold: 'پلورل شوی',
      saleType: 'پلور',
      rentType: 'کرایه',
      gerawiType: 'ګروي',
      available: 'شتون لري',
      inNegotiation: 'د خبرو اترو لاندې',
      rented: 'په کرایه ورکړل شوی'
    },
    details: {
      price: 'بیه',
      area: 'مساحت',
  ...
  [Language.ENGLISH]: {
    ...
    home: {
      ...
      trustSubtitle: 'In a landscape of uncertainty, we deploy definitive institutional verification to eliminate your risk entirely.',
      featuredTitle: 'Featured Institutional Asset',
      saleSectionTitle: 'Properties for Sale',
      rentSectionTitle: 'Properties for Rent',
      gerawiSectionTitle: 'Properties for Gerawi',
