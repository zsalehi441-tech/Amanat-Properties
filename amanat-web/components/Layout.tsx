      ...
      <footer className="bg-slate-50 dark:bg-brand-dark py-24 border-t border-slate-100 dark:border-brand-charcoal">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-20">
            <AmanatLogo className="mb-8 opacity-90" size={240} isDarkMode={isDarkMode} />
          ...
          <div className="grid md:grid-cols-3 gap-16 border-t border-slate-200 dark:border-brand-charcoal/30 pt-20">
            ...
            <div className="text-center order-first md:order-none">
              ...
              <p className="text-brand-gold text-sm md:text-xl font-bold mb-4 tracking-[0.1em] md:tracking-widest uppercase px-4 break-all md:break-normal whitespace-normal">propertiesamanat@gmail.com</p>
              <div className="flex justify-center gap-8 mt-10">
                <a href="https://wa.me/93791606227" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-white transition-all duration-300 hover:scale-110" aria-label="WhatsApp">
                ...
                <a href="https://www.facebook.com/profile.php?id=61586365340712" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-white transition-all duration-300 hover:scale-110" aria-label="Facebook">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </a>
                <a href="https://www.instagram.com/amanat_properties" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-white transition-all duration-300 hover:scale-110" aria-label="Instagram">
                ...
                <a href="https://www.tiktok.com/@amanatproperties" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-white transition-all duration-300 hover:scale-110" aria-label="TikTok">
                ...
                <a href="https://www.youtube.com/@AmanatProperties-k7w" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-white transition-all duration-300 hover:scale-110" aria-label="YouTube">
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-4 text-[13px] text-slate-500 dark:text-slate-400 font-light tracking-wide">
                <li>{lang === Language.ENGLISH ? "Ghazni, Jaghori, Sangi-e-Masha" : "غزنی، جاغوری، سنگ ماشه"}</li>
